...
uses
  ...
  Vcl.ComCtrls, Vcl.CheckLst, Vcl.Mask, Vcl.DBCtrls, Vcl.Grids, Vcl.DBGrids,
...
uses UDataModule, n2_cagendamentos;

procedure TForm34.atualizar_grid;
begin
...
function TForm34.buscarpreco(id_servico: Integer): Currency;
begin
  Result := 0;
...
procedure TForm34.CheckListBoxProfissionaisClick(Sender: TObject);
var
  i, id_pro: Integer;
begin
...
procedure TForm34.CLBHorariosClick(Sender: TObject);
var
  i: Integer;
begin
...
procedure TForm34.CLBServicosClickCheck(Sender: TObject);
var
...
procedure TForm34.erro_servicos;
begin
  Timer1.Enabled := true;
  Label4.visible := true;
end;
...
procedure TForm34.MonthCalendar1Click(Sender: TObject);
var
...
procedure TForm34.Panel2Click(Sender: TObject);
begin
  Cadastrar;
end;
...
procedure TForm34.TrazerHorariosDisponiveis(id_pro: Integer;
...
procedure TForm34.Trazerservicos(DiaSemana: Integer; DataSelecionada: Tdate);
begin
